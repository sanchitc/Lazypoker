...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'bg-felt-rim/60 brass-hairline px-3 py-2',
      'text-sm text-bone',
      'placeholder:text-bone-dim',
      'focus:outline-none focus:ring-2 focus:ring-brass focus:ring-offset-2 focus:ring-offset-felt-deep',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'bg-felt brass-hairline shadow-[0_20px_60px_-20px_rgba(0,0,0,0.7)]',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-brass/15 focus:text-bone',
